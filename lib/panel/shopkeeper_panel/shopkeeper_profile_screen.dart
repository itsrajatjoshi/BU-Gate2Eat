...
// Profile Screen (0% redesign from User Profile Page)
// UI/UX Prototype
...
class ShopkeeperProfileScreen extends ConsumerStatefulWidget {
  const ShopkeeperProfileScreen({super.key});

  @override
  ConsumerState<ShopkeeperProfileScreen> createState() =>
      _ShopkeeperProfileScreenState();
}

class _ShopkeeperProfileScreenState
  ...
  void initState() {
    ...
    _nameController = TextEditingController(
      text: localStorage.userName.isNotEmpty
    ...
    final confirmed = await showDialog<bool>(
      ...
      builder: (ctx) {
        ...
        return AlertDialog(
          ...
          content: const Text(
            'Are you sure you want to log out from the Shopkeeper Panel?',
          ),
          actions: [
            TextButton(
