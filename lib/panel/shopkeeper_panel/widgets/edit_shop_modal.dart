...
// Edit Shop Modal (With Shop Banner Image Picker Max 1MB from Gallery / Phone)
...
class EditShopModal extends StatefulWidget {
  const EditShopModal({
    required this.shop,
    super.key,
  });
  ...
  @override
  State<EditShopModal> createState() => _EditShopModalState();
}

class _EditShopModalState extends State<EditShopModal> {
      ...
      SnackBar(
        content: Row(
          children: [
            ...
            Expanded(
              child: Text(
                'UI Prototype: "$name" details updated (No backend write)',
